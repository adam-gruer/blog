...
I am not sure how to create links from R chunks my attempts to use <code>
blogdown::shortcode("relref", "post/guards-guards-purrr-map-if")</code> or 
<code>
blogdown::shortcode_html("relref", "post/guards-guards-purrr-map-if")</code> 
caused my netlify build to fail. 
